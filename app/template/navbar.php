                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
                        ...
                        <li class="user-header bg-primary">
                            <img src="/images/<?= $this->session->user->UserImage == Null ? "default-user-image.png" : $this->session->user->UserImage ?>" class="img-circle elevation-2" alt="User Image">
                            <p>
                        ...
                        <li class="user-footer">
                            ...
                            <a href="/auth/logout" class="btn btn-default btn-flat float-right"><?= $tempDict["logout"] ?></a>
                        </li>
                    </ul>
                </li>
            </ul>
